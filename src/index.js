...
function cardMotion() {
  ...
  switch (true) {
    case width <= 1300 && width > 1020:
      return (card.style.width = "600px");
    case width <= 1020 && width > 940:
      return (card.style.width = "555px");
    case width <= 940 && width > 865:
      return (card.style.width = "510px");
    case width <= 865 && width > 670:
      return (card.style.width = "461px");
    case width <= 670 && width > 560:
      return (card.style.width = "390px");
    case width <= 560:
      return (card.style.width = "auto");
    default:
      card.style.width = "643px";
  }
}

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleResize() {
        ...
        (width <= 1439) ? description.classList.remove('d-inline-block') : description.classList.add('d-inline-block');
        ...
        (width <= 520) ? document.querySelector('.description > p').style.fontSize = '14px' : document.querySelector('.description > p').style.fontSize = '16px'
    }
